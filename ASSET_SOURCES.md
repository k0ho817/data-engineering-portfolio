...
2026-09-21 개편은 기존 실제 이미지 자산을 유지하고 SQL 코드 및 근거 문서를 추가했습니다. SQL 표시 코드는 `pipeline/schema.sql`에서 발췌했습니다. FineWeb 숫자는 2026-08 작성된 공유 저장소 메타데이터의 50,000문서·104,683시퀀스·길이512·잔여152토큰 기록입니다. 원천 재집계 결과가 아닙니다. Spark와 Milvus의 구현 범위는 [추가 기록](reports/data-pipelines.md), MySQL 팀 기여와 수업 실습의 범위는 [SQL 기록](reports/sql-experience.md)에 구분했습니다. 내부 서버 수집본·인증 설정·교과 원문은 추가 공개하지 않았습니다.
